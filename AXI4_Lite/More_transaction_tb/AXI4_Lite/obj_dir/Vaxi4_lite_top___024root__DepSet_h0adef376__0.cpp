...
VL_INLINE_OPT void Vaxi4_lite_top___024root___nba_sequent__TOP__0(Vaxi4_lite_top___024root* vlSelf) {
    ...
    vlSelfRef.R_data = ((4U == (IData)(vlSelfRef.axi4_lite_top__DOT__u_axi4_lite_slave0__DOT__state))
...
#endif
            VL_FATAL_MT("axi4_lite_top.sv", 3, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("axi4_lite_top.sv", 3, "", "Active region did not converge.");
            }
